...
<title>Products Admin List</title>
...
<br/>
	...
	<div class="panel-group">
		<div class="panel panel-primary" style="border:1px solid black;">
			<div class="panel-heading " style="background-color:#ff5252;"><button type="button" class="btn btn-info btn-sm myBoldFont pull-right" id="myBtn">Add New Product</button>
...
<tr><th>Product Id</th><th>Product Name</th><th>Product Description</th><th>Price</th><th>Product Quantity</th><th>Category</th><th>Supplier</th><th>Product Image<th colspan="2">Operation</th></tr>
...
<td><img src="resources/images/${product.pro_imagename}" alt="${product.pro_name}" width="150px" height="50px"></td>
<td>
<a href="<c:url value="updateProduct?proId=${product.pro_id}"/>" id="update" class="btn btn-info myBoldFont">Update</a>
</td><td>
