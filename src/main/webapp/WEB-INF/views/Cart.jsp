...
<div class="container">
<table class="table">
<div class="list-group-item list-group-item-info row" style="background-color:#ff5252;color:#fff;"><center><h3><b>MY CART</b></h3></center></div>
...
<img src='<c:url value="/resources/images/${cartItem.prod_id}"/>.jpg' alt="${cartItem.prod_name}" style="height:100%;"/>
    ...
    <div class="col-sm-4">
    Quantity : 
     <div class="btn-group"><a href="updateCart?id=${cartItem.cart_item_id}&action=decrease" class="btn btn-danger">
    <span class="glyphicon glyphicon-minus"></span></a><span class="btn">${cartItem.quantity}</span>
    <a href="updateCart?id=${cartItem.cart_item_id}&action=increase" class="btn btn-success">
...
<div class="col-sm-3">
<a href="checkOut" class="btn btn-info btn-block myBoldFont">Check Out</a>
</div></c:if>
</div></td></tr></table></div>
