...
<title>Supplier Admin List</title>
  ...
  <div class="modal" id="warningModal" role="dialog">
	...
	<div class="panel-group">
		<div class="panel panel-primary" style="border:1px solid black;">
			...
			<button type="button" class="btn btn-info btn-sm myBoldFont pull-right" id="myBtn">Add New Supplier</button>
				...
				<table class="table table-hover">
					...
					<c:forEach items="${supDetails}" var="supplier">
						<tr>
							...
							<td>
								<a href="<c:url value="updateSupplier/${supplier.sup_id}"/>" id="update" class="btn btn-info myBoldFont">Update</a>
