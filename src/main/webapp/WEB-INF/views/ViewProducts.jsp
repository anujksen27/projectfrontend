...
<div class="col-sm-offset-3 col-sm-6" style="border:2px solid #ff5252"></div>
<div class="col-sm-1">&nbsp;</div>
<div class="dropdown col-sm-2" style="width:0">
    <button class="btn btn-info myBoldFont"><span class="fa fa-sort"></span> Sort
    </button>
...
<div class="col-sm-6 col-md-3" ng-repeat="product in products | filter:searchProduct | orderBy:myOrderBy">
    <div class="thumbnail">
      <a href="productDetails?proid={{product.pro_id}}">
        <img src="${pageContext.request.contextPath }/resources/${product.pro_imagename}"<%-- '<c:url value="resources/images/${product.pro_imagename}"/>' --%> alt="{{product.pro_name}}" style="height:60%;"/>
        <div class="caption">
