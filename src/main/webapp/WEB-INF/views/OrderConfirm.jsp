...
<div class="list-group-item list-group-item-info" style="background-color:#ff5252;color:#fff;">
...
<div class="col-sm-3">
<a href="shipping?cartId=${cartId}" class="btn btn-info btn-block myBoldFont" id="next">Next</a>
</div>
</div></td></tr></table>
</div>
</div>
